 ...
 */
public class RunTwenty48 implements Runnable {
    public void run() {
        ...
        // Instruction pop up
        String instruct = "Use the up, down, left, and right arrows to combine like tiles and " +
                "work up to 2048! \n" +
                "Use the undo button to undo moves, and the save and resume if you want to exit " +
                "the game and \n" +
                "start where you paused later on! Have fun :)";
